namespace PO1.ClassBoxData
{
    ...
    public class Box
    {
        ...
        private const string StringExeptionMessage =
            ...
            private set
            {
                if (value <= BoxPropertyMinValue)
                {
                    throw new ArgumentException
                        (String.Format(StringExeptionMessage, nameof(this.Length)));
                }
                this.length = value;
            }
        ...
        public double Width
        {
            ...
            private set
            {
                ...
                {
                    throw new ArgumentException
                        (String.Format(StringExeptionMessage, nameof(this.Width)));
                }
        ...
        public double Height
        {
            ...
            private set
            {
                if (value <= BoxPropertyMinValue)
                {
                    throw new ArgumentException(String.Format(StringExeptionMessage, nameof(this.Height)));
                }
                this.height = value;
            }
        }
